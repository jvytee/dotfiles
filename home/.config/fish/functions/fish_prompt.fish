function fish_prompt --description 'Prompt ausgeben'
    ...
    echo -n -s (set_color $fish_color_user) "$USER" $normal @ (set_color $fish_color_host) (prompt_hostname) $normal ' ' (set_color $color_cwd) (prompt_pwd) (set_color magenta) (__fish_vcs_prompt) $normal $prompt_status $suffix " "
end
